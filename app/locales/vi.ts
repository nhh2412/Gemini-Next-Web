...
const vi: PartialLocaleType = {
  ...
  Chat: {
    SubTitle: (count: number) => `${count} tin nhắn với Gemini`,
    Actions: {
  ...
  Settings: {
    ...
    Access: {
      CustomEndpoint: {
        ...
        SubTitle: "Use custom Google service",
      },
      Provider: {
        Title: "Model Provider",
        SubTitle: "Select Google",
      },
    },
    ...
    FontSize: {
      Title: "Cỡ chữ",
      SubTitle: "Thay đổi cỡ chữ của nội dung trò chuyện",
    },
    Sync: {
      LocalState: "Dữ liệu cục bộ",
      Overview: (overview: any) => {
        return `${overview.chat} cuộc trò chuyện，${overview.message} tin nhắn，${overview.prompt} prompts`;
      },
    },
    InjectSystemPrompts: {
    ...
    SendPreviewBubble: {
      ...
      SubTitle: "Xem trước nội dung phần đánh dấu trong bong bóng",
    },
    Mask: {
      Splash: {
    ...
    TopP: {
      Title: "Top P",
      SubTitle: "Không thay đổi giá trị này cùng với temperature",
    },
    MaxTokens: {
  ...
  Context: {
    ...
    Add: "Thêm tin nhắn",
    Clear: "Cuộc trò chuyện được làm mới",
    Revert: "Hoàn lại",
  },
  Plugin: {
    Name: "Plugin",
